...
def prompt(text: str, options: list[str] | None = None, participant: str | None = None, criteria: dict | None = None, explanation: str | None = None) -> dict:
    """Build the payload an `interrupt()` hands back to the caller."""
    return {"text": text, "options": options or [], "participant": participant, "criteria": criteria or {}, "explanation": explanation or ""}
